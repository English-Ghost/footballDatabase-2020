...
//  static String pwd = "127001211";
  ...
  private static void connectDB(String user, String pwd) {
	     try {
  ...
  protected static void popupDatabaseWindow()
  {
    ...
    /*{
    	...
    	//int x = 10;
         ...
         columnNames = jdbcpostgreSQLGUI.getColumnNames(conn,baseTableOption);
         
         
         
    	}
    System.out.println(baseTableOption);
